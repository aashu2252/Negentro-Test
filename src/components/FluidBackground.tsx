...
export const FluidBackground: React.FC = () => {
	...
	useEffect(() => {
		...
		try {
			cleanup = fluidSimulation(canvas)
		} catch (err) {
			console.error("WebGL fluid simulation error:", err)
		}
	...
	return (
		<>
			...
			{/* 2b. Film grain overlay with SVG turbulence filter */}
			<div
				className="absolute inset-0 z-2 pointer-events-none opacity-[0.035] mix-blend-screen"
				style={{
